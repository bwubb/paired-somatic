...
def make_outfile(infile):
    ...
    #make it vcf at first and bgzip it and tabix it
    return f"{dir}/{outfile}"

def std_lancet(infile,tumor,normal):
    pass
...
def parse_arguments():
    ...
    #p.add_argument('--caller',choices=['mutect2','strelka2','vardict','varscan2'],help='Caller name')
    #p.add_argument('--mode',choices=['somatic','germline'],default='germline',help='Call type')
    p.add_argument('--mode',choices=['mutect2','strelka2','vardict','varscan2'],default='germline',help='Call type')
...
def parse_snakemake():
    ...
    #argv['caller']=snakemake.params['caller']
...
def main(argv=None):
    ...
    #Put in function and run on outfile for each mode
